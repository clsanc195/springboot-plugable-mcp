...
class DefaultDynamicToolLoaderTest {
    ...
    void setUp() {
        ...
        properties = new DynamicToolProperties(new DynamicToolProperties.Refresh(false, null), null);
    ...
    void schedulesRefreshWhenEnabled() {
        var refreshProps = new DynamicToolProperties(new DynamicToolProperties.Refresh(true, Duration.ofMinutes(5)), null);
        ToolDefinitionSource source = List::of;
